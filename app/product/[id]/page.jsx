    ...
    fetchProductData();
      ...
      useEffect(()=>{
          if(products.length>0 && productData){
              ...
              productCopy=productCopy.filter((item)=>item.category===productData.category && item._id !== productData._id);
              ...
              <table className="table-auto border-collapse w-full max-w-72">
                <tbody>
                  <tr>
                    ...
                    <td className="text-gray-800/50 ">Lorem</td>
                  </tr>
                  {/* <tr>
        ...
        <div className="flex flex-col items-center">
          <div className="flex flex-col items-center mb-4 mt-16">
            <p className="text-3xl font-medium">
              Related {" "}
              <span className="font-medium text-[#009bf1]">Products</span>
            </p>
